...
#
# В этом скрипте загружаются результаты базового эксперимента,
# строятся гистограммы, график накопленного числа атак и QQ-график
# для проверки экспоненциальности интервалов между атаками.
#
